...
(function($) {
    ...
    $.fn.orbit = function(options) {
        ...
        return this.each(function() {
            ...
            //Timer info
            if(options.timer) {         	
                var timerHTML = '<div class="timer" title="Pause"><span class="mask"><span class="rotator"></span></span><span class="pause"></span></div>'
            ...
            if(options.directionalNav) {
                var directionalNavHTML = '<div class="slider-nav"><span class="right" title="Next">Right</span><span class="left" title="Previous">Left</span></div>';

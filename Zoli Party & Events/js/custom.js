	...
	/* ---------------------------------------------------------------------------
		...
		function sideSlide(){
			...
			var reset = function( time ){
				...
				$( '.lang-active.active', slide ).removeClass('active').children('i').attr('class','fas fa-chevron-down fa-xs');
			...
			$( '.lang-active', slide ).on( 'click', function(e){
				...
				if( el.hasClass('active') ){
					...
					$( '.lang-wrapper', slide ).fadeOut(0);
					$( '.menu_wrapper, .social', slide ).fadeIn(300);
					el.children('i').attr('class','fas fa-chevron-down fa-xs');
					
				} else {
					
					$( '.lang-wrapper', slide ).fadeIn(300);
					$( '.menu_wrapper, .social', slide ).fadeOut(0);
					el.children('i').attr('class','fas fa-chevron-up fa-xs');
...
$('.offer_ul').each( function(){
			...
			slider.slick({
				...
				prevArrow		: '<a class="button button_large button_js slider_prev" href="#"><span class="button_icon"><i class="fas fa-chevron-up"></i></span></a>',
				nextArrow		: '<a class="button button_large button_js slider_next" href="#"><span class="button_icon"><i class="fas fa-chevron-down"></i></span></a>',
